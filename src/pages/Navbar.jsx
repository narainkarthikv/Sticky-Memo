        ...
        <div className="navbar">
            ...
            <div className="nav-profile">
                ...
                <div className="dropdown">
                    {isAuthenticated ? <Link to="/login" className="dropdown-items" onClick={logout}><span>Logout</span></Link> : <Link to="/login" className="dropdown-items"><span>Login</span></Link>}
                    {isAuthenticated?<Link to="/editUser" className="dropdown-items"><span>Edit Profile</span></Link>:<Link to="/register" className="dropdown-items"><span>Register</span></Link>}
